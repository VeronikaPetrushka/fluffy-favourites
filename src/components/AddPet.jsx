    ...
    return (
        <LinearGradient colors={['#26c642', '#03badc']} style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <Image source={require('../assets/decor/empty.png')} style={{width: 234, height: height * 0.17, marginBottom: height * 0.05, alignSelf: 'center'}} />
                    ...
                    <TouchableOpacity style={styles.imageContainer} onPress={uploadImage}>
                        {
                            image ? (
                                ...
                                <Image source={require('../assets/decor/image.png')} style={{width: 88, height: 80, resizeMode: 'contain'}} />
                            )
                        }
                        {image ? (
