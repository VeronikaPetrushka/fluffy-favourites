...

                {
                    started ? (
                                    ...
                                    <View style={{width: '100%', alignItems: 'center', marginVertical: 'auto'}}>
                                        ...
                                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                            <TouchableOpacity onPress={handleRetry}>
                                                <Image source={require('../assets/decor/retry.png')} style={{width: 105, height: 105, resizeMode: 'contain', marginRight: 10}} />
                                            </TouchableOpacity>
                                            <TouchableOpacity onPress={handleGoBack}>
                                                <Image source={require('../assets/decor/home.png')} style={{width: 105, height: 105, resizeMode: 'contain'}} />
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                                ) : (
                        ...
                        <View style={{marginTop: height * 0.1, alignItems: 'center'}}>
                            ...
                            <Image source={require('../assets/decor/empty.png')} style={{width: 234, height: height * 0.24}} />
                        </View>
                    )
                }
